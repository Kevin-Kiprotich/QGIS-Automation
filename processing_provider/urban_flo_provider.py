...
from .urban_flo_algorithm import UrbanFloAlgorithm


class UrbanFloProvider(QgsProcessingProvider):
    ...
    def loadAlgorithms(self):
        ...
        """
        self.addAlgorithm(UrbanFloAlgorithm())
        # self.addAlgorithm(UrbanFloAlgorithmPhase2())
